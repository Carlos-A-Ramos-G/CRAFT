...
CRAFT_WD="/path/to/project/KM3/middle"
CRAFT_CONFIG="/path/to/project/config_middle.yaml"
...
echo "[$(date '+%H:%M:%S')] Phase 2a -- geometry optimisation (KM3_opt.com)"
g16 < "$CRAFT_WD/KM3_opt.com" > "$CRAFT_WD/KM3_opt.log"
